...
public sealed class SingleFileComponentGeneratorTests
{
    ...
    public void Generates_PartialClassWithCompiledRender_ForWellFormedComponent()
    {
        ...
        // column 13), whose former template bridge (base list + explicit name + style scope + setup)
        // made it mountable and exposed Context/OnSetup to @script, whose
...
using static global::Assimalign.Viu.LegacyRenderSurface;
...
namespace Demo
{
    ...
    partial class Counter : global::Assimalign.Viu.Components.ComponentTemplateBase, global::Assimalign.Viu.Components.LegacyTemplateContract
    {
        /// <summary>
...
#line default
        ...
        // [V01.01.06.07] The former template bridge: the generated context and Setup make this
        ...
        /// </summary>
        string? global::Assimalign.Viu.Components.LegacyTemplateContract.Name => "Counter";

        /// <summary>Gets the compiler-produced style scope identifier.</summary>
        string? global::Assimalign.Viu.Components.LegacyTemplateContract.StyleScope => ScopeId;
        ...
        /// </summary>
        /// <param name="context">The mounted component's current arguments, slots, services, lifecycle, and event emitter.</param>
        /// <returns>The render function producing the component's subtree.</returns>
        global::Assimalign.Viu.Components.ComponentRenderer global::Assimalign.Viu.Components.LegacyTemplateContract.Setup(
            global::Assimalign.Viu.Components.LegacyComponentContext context)
        {
            Context = context;
            OnSetup();
            ...
            return () => global::Assimalign.Viu.LegacyRenderSurface.NormalizeRoot(Render(this, _cache));
        }
