...
public sealed class SingleFileComponentGeneratorTests
{
    ...
    {
        // [V01.01.06.17] Ordinary component CSS stays in the generated asset without attribute stamping.
        ...
        var generated = Normalize(GeneratorTestHarness.GeneratedSource(outcome, "Counter.SingleFileComponent.g.cs"));
        generated.ShouldContain(
            "partial class Counter : global::Assimalign.Viu.Components.ComponentBase, " +
            "global::Assimalign.Viu.Components.IComponent");
        generated.ShouldContain(
            "private static global::Assimalign.Viu.Components.VirtualNode? __ViuRender(" +
            "Counter component, global::Assimalign.Viu.Components.ComponentRenderFrame frame)");
        generated.ShouldContain("#line (2,13)-(2,20)");
        generated.ShouldContain("global::Assimalign.Viu.DisplayStringFormatter.ToDisplayString(component.message)");
        generated.ShouldContain("ComponentContract __ViuContract = new(");
        generated.ShouldContain("ComponentRegistration __ViuRegistration = new(");
        generated.ShouldContain("ComponentReference.ForName(\"Counter\")");
        generated.ShouldContain("IComponent.Setup(");
        generated.ShouldContain("return frame => __ViuRender(this, frame);");
    ...
    public void RenderlessComponent_StaysAPlainPartialClass_WithNoComponentBridge()
    {
        ...
        // runtime component base list, no Setup — so it never suddenly demands a template or a runtime
    ...
    public void GeneratedRenderFile_ParsesAsValidCSharp()
    {
        ...
        generated.ShouldContain("ComponentReference.ForName(\"MyButton\")");
        generated.ShouldContain("var listSource");
        generated.ShouldContain("foreach (var listItem");
        generated.ShouldContain("component.items");
        generated.ShouldContain("RenderGlue.ComponentListener(component.onPress)");
