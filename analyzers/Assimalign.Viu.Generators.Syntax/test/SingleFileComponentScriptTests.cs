...
public sealed class SingleFileComponentScriptTests
{
    ...
    public void MalformedScript_SurfacesRecoverableScriptDiagnostic_AtViuCoordinates()
    {
        ...
        diagnostic.Id.ShouldBe("VIU1201");
    ...
    public void Classification_MapsEachMemberShape_ToItsBindingType()
    {
        ...
        const string content =
            ...
            "    public global::Assimalign.Viu.Reactivity.IReactiveReference<int> Qualified = default!;\n" +
        ...
        map["Contract"].ShouldBe(BindingType.SetupReference);
        map["UntypedContract"].ShouldBe(BindingType.SetupReference);
    ...
    public void MalformedHoistedUsing_SurfacesRecoverableScriptDiagnostic_OnTheViuFile()
    {
        ...
        // (the same guarantee the member region already had): a using missing its ';' surfaces a VIU1201
        ...
        outcome.Diagnostics.ShouldContain(diagnostic =>
            diagnostic.Id == "VIU1201" && diagnostic.Location.GetLineSpan().Path == $"{ProjectDirectory}/Widget.viu");
    }
