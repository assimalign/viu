...
/// property with a per-property <see cref="Dependency"/>: the getter tracks, the setter triggers only
...
{
    private const string ReactiveAttributeName = "Assimalign.Vue.Reactivity.ReactiveAttribute";
    private const string ShallowReactiveAttributeName = "Assimalign.Vue.Reactivity.ShallowReactiveAttribute";
