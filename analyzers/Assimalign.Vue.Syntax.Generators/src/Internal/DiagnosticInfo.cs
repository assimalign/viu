...
// The project namespace is nested under Assimalign.Vue.Syntax, so the base cluster's Diagnostic type is
...
/// comparable so unrelated edits stay cached. The <see cref="Descriptor"/> is a stable VUECS-prefixed
/// <see cref="DiagnosticDescriptor"/> mapped from a base <c>Assimalign.Vue.Syntax</c> diagnostic, and
