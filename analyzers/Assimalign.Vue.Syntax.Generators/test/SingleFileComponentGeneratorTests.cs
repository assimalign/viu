...
public sealed class SingleFileComponentGeneratorTests
{
    ...
    public void Generates_PartialClassWithCompiledRender_ForWellFormedComponent()
    {
        ...
        // column 13), and whose @script seam ([V01.01.06.03]) stays untouched. The render body binds by
        // name against both helper surfaces — the runtime-core import and the DOM import ([V01.01.04.09]).
        const string expected =
"""
// <auto-generated/>
#nullable enable

using static global::Assimalign.Vue.RuntimeCore.RenderHelpers;
using static global::Assimalign.Vue.RuntimeDom.DomRenderHelpers;
...
""";
    ...
    public void InvalidTemplateExpression_RemapsRoslynSubExpressionSpan_OntoTheViuFile()
    {
        ...
        // acceptance criterion, surfaced as VUECS1101.
        const string source =
            "@template {\n" +
