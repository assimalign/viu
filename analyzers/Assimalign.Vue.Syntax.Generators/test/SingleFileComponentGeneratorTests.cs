...
public sealed class SingleFileComponentGeneratorTests
{
    ...
    public void Generates_PartialClassWithCompiledRender_ForWellFormedComponent()
    {
        ...
        // column 13), whose @script seam ([V01.01.06.03]) stays untouched, and whose scoped @style block
        // ([V01.01.06.04]) compiles to the ScopeId + ExtractedStyles constants at the class tail.
