...
## Build & test
- [ ] `dotnet build Assimalign.Vuecs.slnx` succeeds with **0 warnings, 0 errors**.
...
## Build system
- [ ] Project/package refs use `VuecsProjectReference` / `VuecsPackageReference` (no raw refs, no inline
...
- [ ] The work item ([V01.01.NN…]) is referenced; scope creep captured via the `vuecs-work-items` skill.
