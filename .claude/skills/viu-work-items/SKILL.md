...
```pwsh
.claude/skills/viu-work-items/scripts/New-ViuWorkItem.ps1 -Search "keyed diff lis moves"
```
...
.claude/skills/viu-work-items/scripts/New-ViuWorkItem.ps1 -As task `
...
.claude/skills/viu-work-items/scripts/New-ViuWorkItem.ps1 -As feature `
...
.claude/skills/viu-work-items/scripts/New-ViuWorkItem.ps1 -Parent V01.01.11 `
...
.claude/skills/viu-work-items/scripts/New-ViuWorkItem.ps1 -Title "..." -DryRun
```
