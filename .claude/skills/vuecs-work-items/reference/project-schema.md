# Vuecs GitHub Project — schema & manual recipes

Reference for the `vuecs-work-items` skill. Captured from the live project on 2026-07-16.
...
| --- | --- | --- | --- | --- |
| `V01.01.00` | 3 (`.00`) | Program root | `[V01.01.00] Vuecs - Framework Libraries` | — |
...
`V` = Vuecs program; `V01.01` = Framework Libraries. Area epics are titled `Framework - <Area>`.
...
(Program root: `#1 [V01.01.00] Vuecs - Framework Libraries`.)
...
- <Vue 3 API parity reference (vuejs.org / vuejs/core), WHATWG/W3C spec for DOM behavior, or a note that it is a Vuecs runtime-contract concern>
```
