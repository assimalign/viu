...
/// <paramref name="trigger"/> delegates wired to the reference's dependency and returns the getter/setter
...
/// built-in cells do not cover. Specified by <c>[RCT-3]</c> and <c>[RCT-4]</c>.
/// </summary>
