...
/// <see cref="object"/> handler (the shape components rendering through the host-operation abstraction
...
/// <para>
/// Ambient process-global state, consistent with the DOM runtime's other single-renderer seams (a browser
