...
/// <summary>
/// The generator-host consumption of the linked DOM knowledge data: builds plain
/// <see cref="HashSet{T}"/> lookups from the linked <c>DomKnowledgeData</c> source (the
/// [V01.01.01.03] source seam), exactly as the runtime <c>DomKnowledge</c> does over frozen
...
/// </summary>
public static class CompilerDomKnowledge
{
