...
/// </summary>
public static class SingleFileComponentDiagnostics
{
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor SingleFileComponentError = new(
        Id: "VIU1001",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor SingleFileComponentWarning = new(
        Id: "VIU1002",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor SingleFileComponentInformation = new(
        Id: "VIU1003",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor ConflictingComponentFormats = new(
        Id: "VIU1004",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor TemplateWarning = new(
        Id: "VIU1102",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor TemplateInformation = new(
        Id: "VIU1103",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor ScriptError = new(
        Id: "VIU1201",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor ScriptWarning = new(
        Id: "VIU1202",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor ScriptInformation = new(
        Id: "VIU1203",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor ReservedScriptMember = new(
        Id: "VIU1204",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor AsynchronousVoidCallback = new(
        Id: "VIU1205",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor UnsupportedScriptLanguage = new(
        Id: "VIU1206",
    ...
    /// </summary>
    public static readonly SingleFileComponentDiagnosticDescriptor ConflictingComponentDeclaration = new(
        Id: "VIU1207",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor DuplicateComponentDeclaration = new(
        Id: "VIU1208",
    ...
    /// </summary>
    public static readonly SingleFileComponentDiagnosticDescriptor UnsupportedComponentDeclaration = new(
        Id: "VIU1209",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor StyleError = new(
        Id: "VIU1301",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor StyleWarning = new(
        Id: "VIU1302",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor StyleInformation = new(
        Id: "VIU1303",
    ...
    /// </summary>
    public static readonly SingleFileComponentDiagnosticDescriptor UnknownComponentParameter = new(
        Id: "VIU1401",
    ...
    public static readonly SingleFileComponentDiagnosticDescriptor MissingRequiredComponentParameter = new(
        Id: "VIU1402",
    ...
    /// ([SFC-USE-4]).
    /// </summary>
    public static readonly SingleFileComponentDiagnosticDescriptor IncompatibleComponentArgument = new(
        Id: "VIU1403",
    ...
    /// </summary>
    public static IReadOnlyList<SingleFileComponentDiagnosticDescriptor> Catalog { get; } = new[]
    {
    ...
    public static (int Line, int Column) ComposeToFilePosition(Position blockContentStart, Position relative)
    {
