...
/// <see cref="FilePath"/> (used both to derive the CSS Modules and binding name salt and to order the
...
/// </summary>
/// <param name="FilePath">The component path (the same path the generator's <c>AdditionalText</c> carries, so the generated and bundled CSS names agree).</param>
