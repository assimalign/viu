...
// (libraries/Assimalign.Vue.RuntimeDom/docs/ADR-0001-interop-marshaling.md), then renders the
...
internal static class VuecsDiagnostics
{
    ...
    internal static async Task RunAsync(int rootHandle)
    {
        ...
        report.AppendLine("VUECS RUNTIME-DOM DIAGNOSTICS");
