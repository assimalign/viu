...
public class ExpressionBindingTests
{
    ...
    public void ProcessExpression_UnknownCssModuleMember_ReportsMappedDiagnostic()
    {
        ...
        error.Code.ShouldBe(CompilerErrorCode.XViuUnknownCssModuleMember);
    ...
    // ---- strict unresolved-identifier diagnostic (Viu-specific) ----
    ...
    public void ProcessExpression_UnknownIdentifierUnderStrictMetadata_ReportsUnresolved()
    {
        ...
        errors.ShouldHaveSingleItem().Code.ShouldBe(CompilerErrorCode.XViuUnresolvedIdentifier);
    }
    ...
    // ---- the Viu event identifier (docs/DESIGN.md: template $event <-> C# __event) ----
