...
/// <c>ErrorCodes</c> — these are <b>Viu-defined</b> codes with no upstream counterpart: the
/// <c>@name { }</c> container is a Viu divergence, so its structural diagnostics have no vuejs/core
