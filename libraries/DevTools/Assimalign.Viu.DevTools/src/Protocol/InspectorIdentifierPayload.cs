...
/// <summary>The inspector identifier payload exchanged by the inspection protocol.</summary>
...
public sealed record InspectorIdentifierPayload(string Identifier);
