...
/// <summary>The state edit request payload exchanged by the inspection protocol.</summary>
...
public sealed record StateEditRequestPayload(int Identifier, string Section, List<string> Path, JsonElement Value);
