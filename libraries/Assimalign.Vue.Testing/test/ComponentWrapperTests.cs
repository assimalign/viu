...
public class ComponentWrapperTests
{
    ...
    {
        using var wrapper = VueTest.Mount(new CounterComponent());
    ...
    {
        using var wrapper = VueTest.Mount(new SelectorComponent());
    ...
    public void FindComponent_LocatesAChildByType_WithExistsAndThrowingVariants()
    {
        ...
        using var wrapper = VueTest.Mount(host);
    ...
    {
        using var wrapper = VueTest.Mount(new InputComponent());
    ...
    public void Stub_ReplacesAChildComponent_WithARecognizablePlaceholderTag()
    {
        ...
        using var wrapper = VueTest.Mount(host, options);
    ...
    public void Provides_FromGlobalConfig_AreInjectableByTheComponent()
    {
        ...
        using var wrapper = VueTest.Mount(new InjectingComponent(), options);
    ...
    public async Task SelfHostedSuite_CounterComponent_DrivesAsyncStateThroughTheRealScheduler()
    {
        ...
        using var wrapper = VueTest.Mount(new CounterComponent(), options);
