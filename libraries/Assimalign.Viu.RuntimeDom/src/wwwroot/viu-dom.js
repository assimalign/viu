// The JS half of the Assimalign.Viu.RuntimeDom interop bridge — the browser implementation of
...
export async function initialize() {
    ...
    const exports = await getAssemblyExports('Assimalign.Viu.RuntimeDom')
    dispatchEvent = exports.Assimalign.Viu.RuntimeDom.BrowserEventDispatch.DispatchBrowserEvent
}
