...
namespace Assimalign.Viu.RuntimeDom.CompiledRenderTests;
...
/// in-memory DOM adapter in <c>Assimalign.Viu.RuntimeDom.Tests.DomRenderHelpersTests</c>, because that
...
public sealed class DomCompiledRenderTests
{
    ...
    public void VoidInlineHandlerWithModifier_CompilesAndExecutes_ThroughWithModifiersFacade()
    {
        ...
        // order matches Assimalign.Viu.RuntimeDom.Events.BrowserEvent).
