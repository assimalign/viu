...
/// <see cref="DomRenderHelpers"/> (Browser). This proves the generator's second <c>using static</c> plus
...
/// in-memory DOM adapter in <c>Assimalign.Viu.Browser.Tests.DomRenderHelpersTests</c>, because that
...
public sealed class DomCompiledRenderTests
{
    ...
    public void VoidInlineHandlerWithModifier_CompilesAndExecutes_ThroughWithModifiersFacade()
    {
        ...
        // order matches Assimalign.Viu.Browser.Events.BrowserEvent).
...
internal static class CompiledRenderSupport
{
    ...
    private static IReadOnlyList<MetadataReference> ResolveReferences()
    {
        ...
        // and its hand-written half bind against — both helper surfaces (Core + Browser), and Shared
