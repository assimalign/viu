...
public static class GeneratorHostDomKnowledge
{
    ...
    /// <summary>All HTML tags from the linked data definition.</summary>
    public static IEnumerable<string> HtmlTags => HtmlTagSet;

    /// <summary>All SVG tags from the linked data definition.</summary>
    public static IEnumerable<string> SvgTags => SvgTagSet;

    /// <summary>All MathML tags from the linked data definition.</summary>
    public static IEnumerable<string> MathTags => MathTagSet;

    /// <summary>All void tags from the linked data definition.</summary>
    public static IEnumerable<string> VoidTags => VoidTagSet;

    /// <summary>All boolean attributes from the linked data definition.</summary>
