...
// plus the one-authoritative-definition contract: the netstandard2.0 generator fixture must agree
// with the net10.0 frozen tables member-for-member.
public class DomKnowledgeTests
{
    ...
    [Fact]
    public void GetAttributeName_CoversTheFrozenCasingExceptions()
    {
