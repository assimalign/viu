...
/// <paramref name="cancellationToken"/> is signalled when the caller cancels, a later navigation
/// supersedes this one, or the router is disposed, so a long-running guard can cooperatively bail
/// out of its own asynchronous work; the pipeline additionally re-checks cancellation between guards. Specified by
/// <c>[RTR-5]</c>.
/// </remarks>
