...
/// <see cref="Router.PushAsync(string, System.Threading.CancellationToken)"/>/<see cref="Router.ReplaceAsync(string, System.Threading.CancellationToken)"/> and handed to every
...
/// </summary>
/// <remarks>
/// A failure is a plain returned value, never an exception: <see cref="Router.PushAsync(string, System.Threading.CancellationToken)"/> completes
