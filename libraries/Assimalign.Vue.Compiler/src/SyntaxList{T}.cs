...
/// <summary>
/// An immutable list of AST nodes with <b>structural</b> equality: two lists are equal when they hold
/// equal elements in the same order. The child/property/modifier collections of the AST records use this
/// so the records compare by value end to end — a plain <see cref="IReadOnlyList{T}"/> or array would
/// compare by reference and silently defeat the incremental-generator cache ([V01.01.05.01]). This is the
/// public analogue of the generators' internal <c>EquatableArray&lt;T&gt;</c> helper.
/// </summary>
/// <typeparam name="T">The element type, a reference type with its own value equality (an AST record).</typeparam>
