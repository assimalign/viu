...
public class StructuralEqualityTests
{
    ...
    {
        var a = new SyntaxList<TextNode>(new[]
        {
            new TextNode { Content = "x", Location = Location(0, 1) },
        });
        var b = new SyntaxList<TextNode>(new[]
        {
            new TextNode { Content = "x", Location = Location(0, 1) },
        });
        var c = new SyntaxList<TextNode>(new[]
        {
            new TextNode { Content = "y", Location = Location(0, 1) },
        });
        ...
        (a != c).ShouldBeTrue();
        SyntaxList<TextNode>.Empty.ShouldBe(default);
    }
