...
/// <summary>
/// A Vuecs plugin — the C# port of upstream's object <c>Plugin</c> form
/// (<c>packages/runtime-core/src/apiCreateApp.ts</c>, https://vuejs.org/guide/reusability/plugins.html).
/// Installed through <see cref="VueApplication{TNode}.Use(IVuePlugin{TNode}, object?)"/>, which
...
public interface IVuePlugin<TNode>
    where TNode : notnull
{
    /// <summary>
    ...
    void Install(VueApplication<TNode> application, object? options);
}
