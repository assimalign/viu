...
/// delegates cannot be arity-inspected, so a Vuecs enter/leave hook always receives
/// <paramref name="done"/> and is responsible for invoking it — the DOM
/// <see cref="Assimalign.Vue.RuntimeCore.BaseTransition"/> wrapper adapts a fire-and-forget
