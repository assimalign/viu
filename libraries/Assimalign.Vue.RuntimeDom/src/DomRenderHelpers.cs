...
/// static imports — <c>using static global::Assimalign.Vue.RuntimeCore.RenderHelpers;</c> and
/// <c>using static global::Assimalign.Vue.RuntimeDom.DomRenderHelpers;</c> — so the members here carry the
...
/// DOM section of <c>Assimalign.Vue.Syntax.Templates/docs/DESIGN.md</c>; this surface satisfies every DOM
...
/// </para>
/// <para>
/// This class layers on <c>Assimalign.Vue.RuntimeDom</c> (the directive singletons <see cref="VShow"/>/
/// <c>VModel*</c> and the <see cref="BrowserEvents"/> modifier/key guards) plus <c>Assimalign.Vue.RuntimeCore</c>
/// (<see cref="IDirective"/>) — never any <c>Assimalign.Vue.Syntax.*</c> assembly. The contract flows one way
