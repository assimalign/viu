...
/// <c>vuecs-dom.js</c> module plus the wrapper layer that converts structured JS failures
/// (<c>vuecs-dom|operation|handle|message</c>) into typed <see cref="BrowserDomException"/>s.
...
internal static partial class BrowserDomBridge
{
    ...
    {
        // Structured bridge errors: "vuecs-dom|operation|handle|message".
        var message = exception.Message;
        if (message.StartsWith("vuecs-dom|", StringComparison.Ordinal))
        {
    ...
    // --- raw imports (module: Assimalign.Vue.RuntimeDom -> wwwroot/vuecs-dom.js) ------------
