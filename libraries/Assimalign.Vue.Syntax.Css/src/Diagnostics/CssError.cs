...
/// (https://www.w3.org/TR/css-syntax-3/#error-handling). A <see cref="Diagnostic"/> whose Vuecs-defined
...
public sealed record CssError : Diagnostic
{
    ...
    public CssError(CssErrorCode code, SourceLocation location)
    {
        ...
        Location = location;
        // The whole Vuecs-defined catalog is recoverable errors, mirroring the single-file-component
