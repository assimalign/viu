...
/// read once per process when the inspection type initializes [DVT-12], so a per-test toggle
...
internal static class RuntimeInspectionSupport
{
    ...
    internal static void Enable() =>
        AppContext.SetSwitch(ReactivityInspection.FeatureSwitchName, true);
}
