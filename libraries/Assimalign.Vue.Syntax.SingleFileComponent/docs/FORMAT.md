...
`Assimalign.Vue.Syntax.SingleFileComponent` defines and parses the `.viu` single-file component (SFC) format — the Vuecs
...
suite (`libraries/Assimalign.Vue.Syntax.SingleFileComponent/test/`) pins every rule stated here.
