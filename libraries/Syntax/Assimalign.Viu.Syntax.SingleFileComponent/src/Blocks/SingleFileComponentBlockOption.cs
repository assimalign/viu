...
/// <summary>
/// A single option or attribute on a block header, such as <c>module</c> or <c>lang="scss"</c>.
/// Represents a tag attribute (<c>&lt;style module&gt;</c> — the canonical <c>.viu</c> template/style
...
/// compare equal.
/// </summary>
/// <param name="Name">The option name (e.g. <c>module</c> or <c>lang</c>).</param>
