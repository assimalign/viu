...
/// resolvers produced by <see cref="RouteComponentProperties"/>; a hand-written delegate is the
...
public delegate VirtualNodeProperties? RouteComponentPropertiesResolver(RouteLocation route);
