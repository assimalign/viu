...
internal static class TransformElement
{
    ...
    public static Action? Transform(TemplateSyntaxNode node, TransformContext context) => () =>
    {
        ...
        TemplateSyntaxNode? vnodeProps = null;
        ...
        bool isDynamicComponent)
    {
        ...
        void PushMergeArgument(TemplateSyntaxNode? argument = null)
        {
        ...
        void AnalyzePatchFlag(Property property)
        {
            ...
            if (key is SimpleExpressionNode { IsStatic: true } staticKey)
            {
                ...
                if (isEventHandler && value is CallExpression handlerCall && handlerCall.Arguments.Count > 0 &&
                    handlerCall.Arguments[0] is TemplateSyntaxNode innerValue)
                {
                    value = innerValue;
                }
        ...
        TemplateSyntaxNode? propsExpression = null;
    ...
    private static TemplateSyntaxNode NormalizeProps(TemplateSyntaxNode propsExpression, TransformContext context, bool hasStyleBinding)
    {
