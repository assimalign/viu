...
/// equal when they hold equal elements in the same order. The collections on <see cref="SingleFileComponentDescriptor"/>,
/// <see cref="SingleFileComponentBlock"/>, and <see cref="SingleFileComponentParseResult"/> use this so those records compare by value
