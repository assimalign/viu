...
/// <summary>
/// A test <see cref="IReactiveWatchScheduler"/> that records queued jobs (deduplicated, as the runtime
/// scheduler does) and runs them on demand, so pre/post flush ordering can be asserted without the
/// runtime scheduler.
/// </summary>
internal sealed class RecordingWatchScheduler : IReactiveWatchScheduler
{
