...
/// <summary>
/// The static-caching pass (specified by <c>[SFC-OPT-1]</c>). It runs once after the transform traversal and before the root
...
{
    /// <summary>Runs the static-caching walk over <paramref name="root"/>.</summary>
    ...
    private static void Walk(TemplateSyntaxNode node, TransformContext context, bool doNotHoistNode)
    {
        ...
        {
            // Only plain elements are eligible for caching; see the type remarks for why the text-call
