...
/// pure (I/O-free) core of the <c>VuecsBundleCss</c> MSBuild task ([V01.01.12.12]). It resolves each
...
public static class SingleFileComponentStyleBundler
{
    private const string Header =
        "/* <auto-generated> Vuecs single-file-component styles ([V01.01.12.12]). "
        + "Do not edit — regenerated by the VuecsBundleCss MSBuild task. */";
