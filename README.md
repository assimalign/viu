...
[![Assimalign.Viu.Sdk.Browser version](https://img.shields.io/nuget/v/Assimalign.Viu.Sdk.Browser?label=Sdk.Browser&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.Sdk.Browser) [![Assimalign.Viu.Sdk.Browser downloads](https://img.shields.io/nuget/dt/Assimalign.Viu.Sdk.Browser?label=Sdk.Browser%20downloads&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.Sdk.Browser) [![Assimalign.Viu.Sdk version](https://img.shields.io/nuget/v/Assimalign.Viu.Sdk?label=Sdk&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.Sdk) [![Assimalign.Viu.Sdk downloads](https://img.shields.io/nuget/dt/Assimalign.Viu.Sdk?label=Sdk%20downloads&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.Sdk) [![Assimalign.Viu.App.Ref version](https://img.shields.io/nuget/v/Assimalign.Viu.App.Ref?label=App.Ref&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.App.Ref) [![Assimalign.Viu.App.Ref downloads](https://img.shields.io/nuget/dt/Assimalign.Viu.App.Ref?label=App.Ref%20downloads&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.App.Ref) [![Assimalign.Viu.App.Browser.Ref version](https://img.shields.io/nuget/v/Assimalign.Viu.App.Browser.Ref?label=App.Browser.Ref&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.App.Browser.Ref) [![Assimalign.Viu.App.Browser.Ref downloads](https://img.shields.io/nuget/dt/Assimalign.Viu.App.Browser.Ref?label=App.Browser.Ref%20downloads&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.App.Browser.Ref) [![Assimalign.Viu.App.Browser.Runtime.browser-wasm version](https://img.shields.io/nuget/v/Assimalign.Viu.App.Browser.Runtime.browser-wasm?label=App.Browser.Runtime&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.App.Browser.Runtime.browser-wasm) [![Assimalign.Viu.App.Browser.Runtime.browser-wasm downloads](https://img.shields.io/nuget/dt/Assimalign.Viu.App.Browser.Runtime.browser-wasm?label=App.Browser.Runtime%20downloads&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.App.Browser.Runtime.browser-wasm) [![Assimalign.Viu.UtilityCss version](https://img.shields.io/nuget/v/Assimalign.Viu.UtilityCss?label=UtilityCss&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.UtilityCss) [![Assimalign.Viu.UtilityCss downloads](https://img.shields.io/nuget/dt/Assimalign.Viu.UtilityCss?label=UtilityCss%20downloads&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.UtilityCss) [![Assimalign.Viu.UtilityCss.Build version](https://img.shields.io/nuget/v/Assimalign.Viu.UtilityCss.Build?label=UtilityCss.Build&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.UtilityCss.Build) [![Assimalign.Viu.UtilityCss.Build downloads](https://img.shields.io/nuget/dt/Assimalign.Viu.UtilityCss.Build?label=UtilityCss.Build%20downloads&logo=nuget)](https://www.nuget.org/packages/Assimalign.Viu.UtilityCss.Build)
...
its test project is in the solution. The Visual Studio Code extensions are TypeScript/npm packages
built through the [area orchestrator](extensions/VisualStudioCode/Build.ps1); the current
[`viu` package](extensions/VisualStudioCode/packages/viu) owns its package-specific build.
