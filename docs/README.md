...
| [`API-HARDENING-PLAN.md`](API-HARDENING-PLAN.md) | The completed `[V01.01.14]` record: adopted public-surface decisions, terminal theme disposition, package-consumer proof, and D12's delivered base/Browser segmentation decision. |
...
| [Documentation home](api-reference/index.md) · [build instructions](api-reference/README.md) | One versioned docfx site for the overview, getting started, guides, library and SDK documentation, specification, and API reference. Offline link validation gates the build; owner-enabled Pages deployment publishes `_out/api-reference/`. |
