...
**Status: ARC AT FULL STOP pending the `[V01.01.15]` component-model swap. Waves 1 and 2A are
complete and merged; remaining work resumes only after the post-swap reevaluation.**
